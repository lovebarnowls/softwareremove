...
For this image, please DO NOT RUN sudo apt-get update && upgrade, as we have over 1GB of updates required, which will take a long time and server cost. You are free to do so for our final image.
