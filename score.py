...
tag  = Forensics
pointValue = 10
parameters = forensic1.txt:302c63ccc99ccf5631abdabdbcc4d372 forensic2.txt:1005 forensic3.txt:ariadne forensic4.txt:goodluckbreakingthiscode
...
pointValue = 2
parameters = john rkhunter sqlite3 terminator unhtml
